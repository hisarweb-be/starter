...
import { getFaqPreviewItems } from "@/lib/server/content-runtime"
import {
...
export default async function FaqPage({
  ...
  return (
    <div className="pb-8">
      ...
      <PageBodySection title="FAQ-context" paragraphs={content.body} />
      <ContentPreviewGrid
        title="FAQ preview"
        description="Zodra Payload FAQ-items beschikbaar zijn, worden ze hier live weergegeven."
        items={items}
      />
    </div>
  )
